...
namespace spawn\system\Core\Base\Database\DBAL;

use spawn\system\Core\Base\Database\DBAL\Aggregation\AbstractAggregation;
use spawn\system\Core\Base\Database\DBAL\Filter\AbstractFilter;
use spawn\system\Core\Base\Database\DBAL\Filter\AndFilter;
use spawn\system\Core\Base\Database\DBAL\Join\AbstractJoin;
